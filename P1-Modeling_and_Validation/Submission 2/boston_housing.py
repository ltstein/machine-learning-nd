...
def explore_city_data(city_data):
    ...
    print "Data Size: ", housing_prices.shape
    # Number of features?
    print "Features: ", housing_features.shape
    # Minimum price?
...
def split_data(city_data):
    ...
    ###################################
    '''Incorrect code retained as record of errors made
    ...
    '''
    #Splt data using train_test_split ensuring a random state is used to shuffle the set
